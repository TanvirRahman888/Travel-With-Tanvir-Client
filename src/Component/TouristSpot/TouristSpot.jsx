        ...
        <div className="bg-blue-100 rounded-2xl my-6">
            <div className="flex items-center justify-between gap-5 p-5">
                ...
                <div className="dropdown dropdown-end">
                    <div tabIndex={0} role="button" className="btn btn-ghost m-1">Sort by</div>
                    <ul tabIndex={0} className="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-52">
                        <li><button className="">Cost High to Low</button></li>
                        <li><button className="">Cost Low to High</button></li>
                    </ul>
                </div>
            </div>
